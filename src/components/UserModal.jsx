...
export default function UserModal({ open, onClose, client }) {
  ...
  {/* ROW 1 — SELECTED */}
  <div className="flex text-sm text-gray-100 py-1 border-b border-gray-700">
  ...
  {/* ROW 2 — SELECTED */}
  <div className="flex text-sm text-gray-100 bg-[#3c3c3c] py-1 border-b border-gray-700">
